return [
    ...
    MYSQL_DEPLOYMENT_NAME: 'production-post-deployment-mysql',
    ...
    MYSQL_SERVICE_NAME: 'production-post-service-mysql',

    // User Service Configuration
    POST_DEPLOYMENT_NAME: 'production-post-deployment-post-service',
    POST_CONTAINER_NAME: 'userservice',
    POST_PORT: 80,
    POST_REPLICAS: 1,
    POST_ENVIRONMENT: 'Production',
    POST_DATABASE: 'PostDatabase',
    POST_SECRET_NAME: 'post-secret-credential',
    POST_SECRET_PASSWORD_KEY: 'ROOT_PASSWORD',
    POST_SERVICE_NAME: 'production-post-service-post-service',
    POST_NODE_PORT: 32010,
